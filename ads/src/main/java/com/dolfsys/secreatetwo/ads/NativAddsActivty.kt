...
abstract class NativAddsActivty:AppCompatActivity() {
                ...
                adsViewModel.adsFlow.collect{ response ->
                    when (response) {
                        is Response.Success -> {
                            ...
                            SavedAds.saveApi(this@NativAddsActivty, adsRoot)
                        ...
                        is Response.error -> {
                            ...
                            adsRoot = SavedAds.getAds(this@NativAddsActivty)
                            if(adsRoot?.showAds == true){
                                filterAdsNetworkId()
                                loadInteritialAds()
                                loadBannerAds()
    ...
    private fun loadAdMobInterstitialAd() {
        try {
            ...
            admobAds?.interstitialAdKey?.let  {
                InterstitialAd.load(this@NativAddsActivty, it, adRequest,
    ...
    private fun showAdMobInterstialAd (){
        try {
            if (mInterstitialAd != null) {
                ...
                mInterstitialAd!!.show(this@NativAddsActivty)
                mInterstitialAd!!.setFullScreenContentCallback(object :
                    ...
                    override fun onAdDismissedFullScreenContent() {
                        ...
                        val adRequest = AdRequest.Builder().build()
                        admobAds?.interstitialAdKey?.let {
                            InterstitialAd.load(this@NativAddsActivty,
                                it,
                                adRequest,
                                object : InterstitialAdLoadCallback() {
                                    override fun onAdLoaded(interstitialAd: InterstitialAd) {
    ...
    fun loadNativeAds(){
        ...
        val nativeAd = fabBookAds?.nativeAdKey?.let {
            NativeAd(this, fabBookAds?.nativeAdKey)
        }
        ...
        val nativeAdListener = object :NativeAdListener{
            ...
            override fun onAdLoaded(p0: Ad?) {
                val adView: View = NativeAdView.render(this@NativAddsActivty, nativeAd)
